// ParticleSphere.tsx — Animated AI search visualization for MKTVLU landing page
// Self-contained canvas component. Drop into any React project.
// Usage: <ParticleSphere size={400} />
