...
This section gives visitors a concrete visual of the actual product output. Two-part layout: phone mockup on one side, exploded breakdown on the other.
...
Build a CSS iPhone frame (rounded rect with notch/dynamic island, ~320px wide, ~640px tall) containing a miniature replica of the results screen. This should show:
...
Inside the phone frame, render a scaled-down (0.5 scale via CSS transform) version of the results page showing:
- Product name: "iPhone 15 Pro Max"
- Variant: "256GB · Natural Titanium · Good"
- MRP: "$987" in large mint text
- Mini price chart (simple SVG line)
- Condition bubbles (Good/Fair/Poor)
- Buy/Sell buttons
- VLU Certified badge in the header

The phone mockup should have a subtle float animation (translateY 6px oscillation over 5s) and a soft shadow glow beneath it.

**Right Column — Exploded Results Breakdown:**
A vertical stack of 6 mini glass-cards, each explaining one section of the results page. Each card has a numbered label, title, and one-line description. They should stagger-reveal top to bottom on scroll.

**1. Market Reference Price**
"The statistically filtered average across all marketplaces. Your single source of truth."
- Visual: large "$987" in mint with "MRP" label

**2. Price Range & Chart**
"Floor to ceiling range with a 30-day price trend showing market direction."
- Visual: simple mini SVG chart line (3 colors: floor red, mrp green, ceiling gray)

**3. Condition Assessment**
"AI-detected condition with price adjustments. Good, Fair, or Poor — each with its own MRP."
- Visual: 3 small pills (Good in green, Fair in yellow, Poor in gray)

**4. Evidence & Sources**
"See exactly how many listings were analyzed and from which platforms."
- Visual: "42 listings · 4 platforms" with small source icons

**5. Price DNA**
"Multi-axis radar scoring confidence, stability, liquidity, demand, and retention."
- Visual: tiny hexagonal radar outline (CSS/SVG, just decorative)

**6. VLU Certified**
"When the listing price falls within the validated MRP range, it earns the VLU Certified stamp."
- Visual: small VLU Certified badge (glass-mint pill)

**Desktop layout:**
```
┌─────────────────────────────────────────────┐
│  [iPhone mockup]     [1. MRP            ]   │
│  showing full        [2. Price Range    ]   │
│  results page        [3. Condition      ]   │
│                      [4. Evidence       ]   │
│                      [5. Price DNA      ]   │
│                      [6. VLU Certified  ]   │
└─────────────────────────────────────────────┘
...
**Mobile:** Phone mockup centered above, exploded cards stacked below.

**Connection lines (optional but impressive):** On desktop, draw thin dashed lines from each numbered card on the right to the corresponding area on the phone mockup on the left, using SVG or absolute-positioned elements. Lines should have a subtle pulse animation. This creates a "blueprint exploded view" effect.
...
src/
  ...
  components/
    ...
    ui/
      ...
      PhoneFrame.tsx     (CSS iPhone mockup frame)
